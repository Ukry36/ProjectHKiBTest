...
[CustomEditor(typeof(GearDataSO))]
public class GearDataCustomInspector : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (skill.graffitiCodes != null)
        {
            ...
            for (int i = 0; i < skill.graffitiCodes.Count; i++)
            {
                ...
                skill.graffitiCodes[i].color = EditorGUILayout.ColorField("color", skill.graffitiCodes[i].color);
