...
[CreateAssetMenu(
    fileName = "SetDirRandomAccuracyAction",
    menuName = "State Machine/Action/SetDir/SetDirRandomAccuracyAction"
)]
public class SetDirRandomAccuracyAction : StateActionSO
{
